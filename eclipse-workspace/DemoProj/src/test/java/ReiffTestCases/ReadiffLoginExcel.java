...
public class ReadiffLoginExcel {
		...
		public void initialize() throws IOException
		{
			//Properties file
			prop = new Properties();
			fis = new FileInputStream("C:\\Users\\Administrator\\eclipse-workspace\\DemoProj\\src\\test\\java\\TestNGPrograms/data.properties");
			prop.load(fis);
			driver = new ChromeDriver();
			driver.get(prop.getProperty("url"));
			//Excel file
			fis = new FileInputStream("C:/Users/Administrator/Desktop/AutomationData.xlsx");
